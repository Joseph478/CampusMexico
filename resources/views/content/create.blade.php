...
@section('content')
    ...
    <div class="main-card mb-3 card">
        ...
        <div class="card-body">
            <form action="{{ route('courses.types.contents.store', [$course->id, $type->id] ) }}" method="POST" enctype="multipart/form-data" id="formGeneral">
                @include('content.partials._form', ['btnText' => 'Guardar'])
            </form>
        </div>
    </div>
